...
public class AnimalArena {
    ...
    public static void main(String[] args) {
        Animal MarioAndLuigi = createAnimalWithDefaultConstructor("Mario and Luigi");
        Animal Sephiroth = createAnimalWithParametrizedConstructor("Sephiroth");
        System.out.println(MarioAndLuigi);
        System.out.println(Sephiroth);
        System.out.println("It's " + MarioAndLuigi.getType() + " vs. " + Sephiroth.getType() + "!");
        System.out.println("FIGHT!");
        fight(MarioAndLuigi, Sephiroth);
    }
    ...
    public static Animal createAnimalWithParametrizedConstructor(String type){
        int startingHealth = (rand.nextInt(MAXHEALTH/2) + 1) + 10;
        int startingStrength = rand.nextInt(MAXSTRENGTH) + 1;
